...
using UnityEngine;
using mingu.sexym; //와!! 다른 스크립트에서도 문제 없이 namespace를 사용할 수 있다!
public class Retro : MonoBehaviour
{
   mingu.sexym.minguClass mingu_class= new mingu.sexym.minguClass();
  ...
  private void Start()
  {
    ...
    Debug.Log("민구의 이름이 제대로 들어갔는가? : "+mingu_class.isname());
    ArrayList();
    //HashTable();
    //Queue();
    //Stack();
