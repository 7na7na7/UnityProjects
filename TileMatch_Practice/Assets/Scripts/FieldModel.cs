...
public static class FieldModel
{
    ...
    public static void Init(int col, int row, int totalTileCount, int imageTypeCount) //타일맵 생성, FiledPresenter에서는 그 타일맵으로 실제 타일 생/
    {
        // 기존 타일맵 삭제
        tileMap = null;
    ...
    public static void ShuffleTile()
    {
        ...
        // 리스트 섞기
        System.Random range = new System.Random();//랜덤으로 섞는다!
